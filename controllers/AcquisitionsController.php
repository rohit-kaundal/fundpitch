...
use app\models\SearchAcquisitions;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AcquisitionsController implements the CRUD actions for Acquisitions model.
 */
class AcquisitionsController extends Controller
{
    ...
    {
        $searchModel = new SearchAcquisitions();
    ...
    {
        if (($model = Acquisitions::findOne($id)) !== null) {
            return $model;
        } else {
